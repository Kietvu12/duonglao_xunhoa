...
--
-- Table structure for table `ban_dich_cache`
--

DROP TABLE IF EXISTS `ban_dich_cache`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ban_dich_cache` (
  `id` int NOT NULL AUTO_INCREMENT,
  `hash_van_ban` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ma_ngon_ngu` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `noi_dung_goc` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `noi_dung_dich` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `ngay_tao` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_translation` (`hash_van_ban`,`ma_ngon_ngu`)
...
CREATE TABLE `benh_nhan_dich_vu` (
  ...
  `hinh_thuc_thanh_toan` enum('ngay','thang','quy','nam') COLLATE utf8mb4_general_ci DEFAULT 'thang',
...
--
-- Table structure for table `diem_muc_uu_tien`
--

DROP TABLE IF EXISTS `diem_muc_uu_tien`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `diem_muc_uu_tien` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `muc_uu_tien` enum('thap','trung_binh','cao') COLLATE utf8mb4_general_ci NOT NULL,
  `diem_so` float NOT NULL DEFAULT '0',
  `ngay_tao` datetime DEFAULT CURRENT_TIMESTAMP,
  `ngay_cap_nhat` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_muc_uu_tien` (`muc_uu_tien`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `do_dung_ca_nhan` (
  ...
  `ngay_tao` datetime DEFAULT CURRENT_TIMESTAMP,
  `ngay_cap_nhat` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `id_nguoi_giao` bigint DEFAULT NULL,
  `id_nguoi_nhan` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `id_benh_nhan` (`id_benh_nhan`),
  KEY `idx_id_phan_loai` (`id_phan_loai`),
  KEY `idx_nguon_cung_cap` (`nguon_cung_cap`),
  KEY `idx_id_nguoi_giao` (`id_nguoi_giao`),
  KEY `idx_id_nguoi_nhan` (`id_nguoi_nhan`),
  ...
  CONSTRAINT `fk_do_dung_nguoi_giao` FOREIGN KEY (`id_nguoi_giao`) REFERENCES `nguoi_than_benh_nhan` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_do_dung_nguoi_nhan` FOREIGN KEY (`id_nguoi_nhan`) REFERENCES `dieu_duong_benh_nhan` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fcm_tokens` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `tai_khoan_id` bigint NOT NULL COMMENT 'ID tài khoản từ bảng tai_khoan',
  `token` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'FCM token từ Firebase',
  `device_type` varchar(20) COLLATE utf8mb4_general_ci DEFAULT 'android' COMMENT 'Loại thiết bị: android, ios',
  `app_type` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Loại app: nurse_app, family_app',
  `is_active` tinyint(1) DEFAULT '1' COMMENT 'Token còn hoạt động: 1=active, 0=inactive',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_tai_khoan_token` (`tai_khoan_id`,`token`),
  KEY `idx_tai_khoan_id` (`tai_khoan_id`),
  KEY `idx_token` (`token`),
  KEY `idx_is_active` (`is_active`),
  KEY `idx_app_type` (`app_type`),
  KEY `idx_user_active_tokens` (`tai_khoan_id`,`is_active`),
  KEY `idx_app_type_active` (`app_type`,`is_active`),
  CONSTRAINT `fk_fcm_tokens_tai_khoan` FOREIGN KEY (`tai_khoan_id`) REFERENCES `tai_khoan` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=289 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Bảng lưu FCM tokens cho push notifications';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `khao_sat_chat_luong`
--

DROP TABLE IF EXISTS `khao_sat_chat_luong`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `khao_sat_chat_luong` (
  `id` int NOT NULL AUTO_INCREMENT,
  `ten_file` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ngay_tao` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `chat_luong` json DEFAULT NULL,
...
CREATE TABLE `kpi_nhan_vien` (
  ...
  `thang` int NOT NULL,
  `nam` int NOT NULL,
  `tong_diem_kiem_duoc` float DEFAULT '0',
  `tong_diem_cong_viec` float DEFAULT '0',
  `ty_le_kpi` float DEFAULT NULL,
  `so_cong_viec_duoc_giao` int DEFAULT '0',
  `so_cong_viec_hoan_thanh_dung_han` int DEFAULT '0',
  `so_cong_viec_hoan_thanh_tre_han` int DEFAULT '0',
  `so_cong_viec_chua_hoan_thanh` int DEFAULT '0',
  `ghi_chu` text COLLATE utf8mb4_general_ci,
  `ngay_tao` datetime DEFAULT CURRENT_TIMESTAMP,
  `ngay_cap_nhat` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_kpi_nhan_vien_thang_nam` (`id_tai_khoan`,`thang`,`nam`),
  KEY `id_tai_khoan` (`id_tai_khoan`),
  KEY `idx_kpi_thang_nam` (`thang`,`nam`),
...
CREATE TABLE `lich_tham_benh` (
  ...
  `ngay_tao` datetime DEFAULT CURRENT_TIMESTAMP,
  `ngay_cap_nhat` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `sdt_nguoi_than` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `id_benh_nhan` (`id_benh_nhan`),
...
CREATE TABLE `phan_cong_cong_viec` (
  ...
  `id_dieu_duong` bigint DEFAULT NULL,
  `id_benh_nhan` bigint DEFAULT NULL,
  `trang_thai` enum('chua_lam','dang_lam','hoan_thanh','xin_hoan') COLLATE utf8mb4_general_ci DEFAULT 'chua_lam',
  `thoi_gian_hoan_thanh` datetime DEFAULT NULL,
  `ly_do_hoan` text COLLATE utf8mb4_general_ci,
  `ngay_tao` datetime DEFAULT CURRENT_TIMESTAMP,
  `ngay_cap_nhat` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `phan_loai_thuoc`
--

DROP TABLE IF EXISTS `phan_loai_thuoc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `phan_loai_thuoc` (
  `id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `tai_khoan` (
  ...
  `ngon_ngu` enum('vi','en','ja','ko') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'vi',
  `da_xoa` tinyint(1) DEFAULT '0',
  `ngay_xoa` datetime DEFAULT NULL,
  `ngay_tao` datetime DEFAULT CURRENT_TIMESTAMP,
  `ngay_cap_nhat` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `thong_bao` (
  ...
  KEY `idx_thong_bao_benh_nhan` (`id_benh_nhan`),
  CONSTRAINT `fk_thong_bao_benh_nhan` FOREIGN KEY (`id_benh_nhan`) REFERENCES `benh_nhan` (`id`) ON DELETE SET NULL,
  CONSTRAINT `thong_bao_ibfk_1` FOREIGN KEY (`id_nguoi_nhan`) REFERENCES `tai_khoan` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=17036 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tu_thuoc`
--

DROP TABLE IF EXISTS `tu_thuoc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tu_thuoc` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `id_phan_loai` bigint DEFAULT NULL,
  `ten_thuoc` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `don_vi_tinh` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `so_luong_ton` int DEFAULT '0',
  `so_luong_toi_thieu` int DEFAULT '0' COMMENT 'Ngưỡng cảnh báo sắp hết',
  `han_su_dung` date DEFAULT NULL,
  `chi_dinh` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `trang_thai` enum('con_hang','sap_het','het_hang','het_han') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'con_hang',
...
--
-- Table structure for table `vat_tu_tieu_hao`
--

DROP TABLE IF EXISTS `vat_tu_tieu_hao`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `vat_tu_tieu_hao` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `id_benh_nhan` bigint DEFAULT NULL,
  `id_nguoi_gui` bigint DEFAULT NULL,
  `id_tu_thuoc` bigint DEFAULT NULL,
  `ten_vat_tu` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `so_luong` int DEFAULT NULL,
  `don_vi_tinh` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ly_do` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `trang_thai` enum('cho_duyet','da_duyet','da_huy','da_su_dung') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'cho_duyet',
  `ngay_tao` datetime DEFAULT CURRENT_TIMESTAMP,
  `ngay_cap_nhat` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `da_xoa` tinyint(1) DEFAULT '0',
  `ngay_xoa` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_vat_tu_id_benh_nhan` (`id_benh_nhan`),
  KEY `idx_vat_tu_id_nguoi_gui` (`id_nguoi_gui`),
  KEY `idx_vat_tu_id_tu_thuoc` (`id_tu_thuoc`),
  CONSTRAINT `fk_vat_tu_benh_nhan` FOREIGN KEY (`id_benh_nhan`) REFERENCES `benh_nhan` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_vat_tu_nhan_vien` FOREIGN KEY (`id_nguoi_gui`) REFERENCES `ho_so_nhan_vien` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_vat_tu_tu_thuoc` FOREIGN KEY (`id_tu_thuoc`) REFERENCES `tu_thuoc` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-09-04  3:47:37
