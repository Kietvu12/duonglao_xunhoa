...
import baiVietSuKienRoutes from './routes/baiVietSuKienRoutes.js';
...
import phanLoaiThuocRoutes from './routes/phanLoaiThuocRoutes.js';
import tuThuocRoutes from './routes/tuThuocRoutes.js';
import vatTuTieuHaoRoutes from './routes/vatTuTieuHaoRoutes.js';
...
app.use('/api/bai-viet-su-kien', baiVietSuKienRoutes);
...
app.use('/api/phan-loai-thuoc', phanLoaiThuocRoutes);
app.use('/api/tu-thuoc', tuThuocRoutes);
