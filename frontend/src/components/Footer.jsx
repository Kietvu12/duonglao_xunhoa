      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div className="flex items-center space-x-4 mb-6">
              <Link to="/" className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <div className="text-xs tracking-wider" style={{ color: '#C9A870' }}>
                    LUXURY SENIOR LIVING
                  </div>
                </div>
              </Link>
            </div>
            <p className="text-gray-400 mb-8 max-w-md leading-relaxed" style={{ fontFamily: "'Playfair Display', serif" }}>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 text-sm" style={{ fontFamily: "'Playfair Display', serif" }}>
              {navLinks.map((link) => (
                <li key={link.path}>
                  <Link
                    to={link.path}
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400 text-sm" style={{ fontFamily: "'Playfair Display', serif" }}>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 flex-shrink-0 mt-0.5" style={{ color: '#C9A870' }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-center gap-3">
                <svg className="w-5 h-5 flex-shrink-0" style={{ color: '#C9A870' }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="pt-8 border-t" style={{ borderColor: 'rgba(255,255,255,0.1)' }}>
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-500" style={{ fontFamily: "'Playfair Display', serif" }}>
